...
# RANSAC function
def ransac_filter(matches, keypoints1, keypoints2, threshold=100, max_iterations=1000):
    best_model = None
    best_inliers = []

    for _ in range(max_iterations):
        # Randomly sample a minimal subset of matches
        sample = np.random.choice(matches, 150, replace=False)
...
threshold = 100  # Distance threshold for inliers
